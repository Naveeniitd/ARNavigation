    ...
    {
        {
            ...
            //Vector3 vect = GeoCoordinatesToUnitySpace.ConvertGeoCoordinatesToUnity((float)routeAPIManager.startLat, (float)routeAPIManager.startLon);
            Vector3 vect = GeoCoordinatesToUnitySpace.ConvertGeoCoordinatesToUnity(routeAPIManager.Starting_Lat, routeAPIManager.Starting_Lon);
            Vector3 _player = new Vector3(vect.x, -1, vect.z);
            //Instantiate(_playerPrefab, _player, Quaternion.identity);
