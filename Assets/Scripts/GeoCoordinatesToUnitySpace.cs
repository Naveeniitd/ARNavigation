...
{
    public static  Vector3 ConvertGeoCoordinatesToUnity(float latitude, float longitude)
    {
        ...
        float unityZ = longitude * longitudeScale;
        float unityX = latitude * latitudeScale;
